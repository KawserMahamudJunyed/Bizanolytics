      ...
      <div className="max-w-4xl mx-auto space-y-6 pt-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="card-base p-8 space-y-8">
          ...
          <div className="flex gap-4 justify-center pt-6">
            <Link href="/" className="px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20">
              Go to Dashboard
            </Link>
          </div>
        </motion.div>
